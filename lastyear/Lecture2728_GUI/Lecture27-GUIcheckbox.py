...
class Mycheck:
    ...
    def __init__(self,root):
        ...
        self.c1=Checkbutton(self.f,bg='yellow',fg='green',variable=self.var1,command=self.display)
        self.c2=Checkbutton(self.f,bg='yellow',fg='green',variable=self.var2,command=self.display)
        self.c3=Checkbutton(self.f,bg='yellow',fg='green',variable=self.var3,command=self.display)
    ...
    def display(self):
        ...
        lbl=Label(text=str,fg='blue').place(x=50,y=150,width=100,height=20)
